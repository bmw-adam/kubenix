  ...
  kubernetes.resources = {
    ...
    services.yugabyte = {
      ...
      spec = {
        ...
        type = "NodePort";
        ports = [
          { name = "master-ui"; port = 7000; targetPort = 7000; protocol = "TCP"; nodePort = 7000; }
          { name = "yb-ui"; port = 9000; targetPort = 9000; protocol = "TCP"; nodePort = 9000; }
          { name = "ysql"; port = 5433; targetPort = 5433; protocol = "TCP"; nodePort = 5433; }
          { name = "ysql-web"; port = 15433; targetPort = 15433; protocol = "TCP"; nodePort = 15433; }
          { name = "ycql"; port = 9042; targetPort = 9042; protocol = "TCP"; nodePort = 9042; }
        ];
      };
    };
  };
